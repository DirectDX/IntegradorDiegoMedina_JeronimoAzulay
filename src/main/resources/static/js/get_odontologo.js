window.addEventListener('load', function () {
    ...
    // Function to get the list of dentists from the server
    function getDentists() {
        fetch('/odontologos')
            ...
            .then(dentists => {
                // Once we get the list of dentists, populate the table
    ...
    function populateDentistTable(dentists) {
        ...
        dentists.forEach(dentist => {
            ...
            deleteButton.addEventListener('click', function () {
                const dentistId = this.closest('tr').querySelector('td:first-child').textContent;
